...
@Component({
  ...
  template: `
    <div class="terminal-backdrop" (click)="close.emit()">
      <div class="terminal-window" (click)="$event.stopPropagation()">
        
        <div class="terminal-header">
          <div class="signal-light" [class.active]="!loading()" [class.busy]="loading()"></div>
          <span class="header-title">IDENTITY UPLINK</span>
        ...
        <div class="terminal-body">
          ...
          @if (!codeSent()) {
            <div class="form-state">
              ...
              <p class="console-text">> ENTER DESIGNATION (EMAIL):</p>
              ...
              <button class="tactical-btn" [disabled]="loading()" (click)="sendCode()">
            ...
            <div class="form-state">
              ...
              <div class="actions">
                <button class="tactical-btn confirm" [disabled]="loading()" (click)="verify()">
...
export class LoginModalComponent {
  ...
  // Use @Output() for Angular < 17 or output() for Angular 17+
  // Assuming Angular 17+ based on your 'signal' usage:
  close = output<void>();
  ...
  async sendCode() {
    ...
    try {
      await this.auth.requestLogin(this.email);
  ...
  async verify() {
    ...
    try {
      await this.auth.verifyLogin(this.email, this.code);
